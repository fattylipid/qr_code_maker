...
FILL_COLOR = os.getenv('FILL_COLOR', 'pink')  # Fill color for the QR code
...
def generate_qr_code(data, path, fill_color='pink', back_color='black'):
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/fattylipid')
